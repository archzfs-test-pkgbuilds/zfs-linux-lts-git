...
pkgver=2018.04.09.r3412.g74df0c5e2.4.14.32.1
pkgrel=1
...
sha256sums=("SKIP")
license=("CDDL")
depends=("kmod" "spl-linux-lts-git" "zfs-utils-common-git=2018.04.09.r3412.g74df0c5e2" "linux-lts=4.14.32-1")
...
package_zfs-linux-lts-git-headers() {
    ...
    sed -i "s+${srcdir}++" ${pkgdir}/usr/src/zfs-*/4.14.32-1-lts/Module.symvers
}
