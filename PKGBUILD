...
pkgver=2018.02.26.r3338.8b5814393.4.14.22.1
pkgrel=1
makedepends=("linux-lts-headers=4.14.22-1" "libelf" "git" "spl-linux-lts-git-headers")
arch=("x86_64")
url="http://zfsonlinux.org/"
source=("git+https://github.com/zfsonlinux/zfs.git#commit=8b5814393f43d7eb7e4319120529d957a5f7bf8e")
sha256sums=("SKIP")
license=("CDDL")
depends=("kmod" "spl-linux-lts-git" "zfs-utils-common-git=2018.02.26.r3338.8b5814393" "linux-lts=4.14.22-1")
...
build() {
    ...
    ./configure --prefix=/usr --sysconfdir=/etc --sbindir=/usr/bin --libdir=/usr/lib \
                ...
                --with-linux=/usr/lib/modules/4.14.22-1-lts/build \
                --with-linux-obj=/usr/lib/modules/4.14.22-1-lts/build
    make
}
...
package_zfs-linux-lts-git-headers() {
    ...
    sed -i "s+${srcdir}++" ${pkgdir}/usr/src/zfs-*/4.14.22-1-lts/Module.symvers
}
