...
pkgver=2018.06.18.r4605.gcd32e5db8.4.14.50.1
pkgrel=1
makedepends=("linux-lts-headers=4.14.50-1" "git")
arch=("x86_64")
url="http://zfsonlinux.org/"
source=("git+https://github.com/zfsonlinux/zfs.git#commit=cd32e5db8bb4411533dc21cfc12a5af5f3b56701")
sha256sums=("SKIP")
license=("CDDL")
depends=("kmod" "zfs-utils-common-git=2018.06.18.r4605.gcd32e5db8" "linux-lts=4.14.50-1")
...
build() {
    ...
    ./configure --prefix=/usr --sysconfdir=/etc --sbindir=/usr/bin --libdir=/usr/lib \
                ...
                --with-linux=/usr/lib/modules/4.14.50-1-lts/build \
                --with-linux-obj=/usr/lib/modules/4.14.50-1-lts/build
    make
}
...
package_zfs-linux-lts-git-headers() {
    ...
    sed -i "s+${srcdir}++" ${pkgdir}/usr/src/zfs-*/4.14.50-1-lts/Module.symvers
}
