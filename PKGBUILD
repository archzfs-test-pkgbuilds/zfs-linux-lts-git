...
pkgver=2018.02.14.r3310.ddc751d56.4.14.19.1
pkgrel=1
makedepends=("linux-lts-headers=4.14.19-1" "libelf" "git" "spl-linux-lts-git-headers")
arch=("x86_64")
url="http://zfsonlinux.org/"
source=("git+https://github.com/zfsonlinux/zfs.git#commit=ddc751d56beee8bf79d352ca3d8253d6238b2dc2")
sha256sums=("SKIP")
license=("CDDL")
depends=("kmod" "spl-linux-lts-git" "zfs-utils-common-git=2018.02.14.r3310.ddc751d56" "linux-lts=4.14.19-1")
...
package_zfs-linux-lts-git-headers() {
    ...
    sed -i "s+${srcdir}++" ${pkgdir}/usr/src/zfs-*/4.14.19-1-lts/Module.symvers
}
